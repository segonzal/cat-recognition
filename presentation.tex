...
\begin{document}
	...
	\begin{frame}{Función de nuestra solución}
		Dado una imagen de consulta, en la que el rostro del animal ya ha sido detectado y etiquetado, se determinará la raza a la que pertenesca. 
	\end{frame}
...
Zhang, Sun, Tang, 2008}}
	...
	\begin{frame}{Innovaciones}
		Para trabajar con perros hay que crear un dataset anotado.
